...
/* Parallax scroll handler removed: it wrote a 3-layer background-position ("100% <y>px, 0%, center top")
   to #main on every scroll. Feature-image headers are a single layer centered by the theme's responsive
   header <style> block, so the first scroll event snapped the image from center to the top-right. */